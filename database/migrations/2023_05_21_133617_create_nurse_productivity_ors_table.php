...
class CreateNurseProductivityOrsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nurse_productivity_ors', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('nurse_productivity_ors');
    }
}
