...
header('Content-Disposition: attachment; filename="ทะเบียนครุภัณฑ์สำนักงาน.xls"');//ชื่อไฟล์
?>

<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white"><strong>ครุภัณฑ์สำนักงาน สถานะใช้งานปกติ</strong></div>  
        <div class="card-body"> 
