...
header('Content-Disposition: attachment; filename="ครุภัณฑ์วิทยาศาสตร์และการแพทย์.xls"');//ชื่อไฟล์
?>

<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white"><strong>ครุภัณฑ์วิทยาศาสตร์และการแพทย์ สถานะใช้งานปกติ</strong></div>  
        <div class="card-body"> 
