...
header('Content-Disposition: attachment; filename="ครุภัณฑ์คอมพิวเตอร์.xls"');//ชื่อไฟล์
?>

<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white"><strong>ครุภัณฑ์คอมพิวเตอร์ สถานะใช้งานปกติ</strong></div>  
        <div class="card-body"> 
