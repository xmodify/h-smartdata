...
header('Content-Disposition: attachment; filename="ครุภัณฑ์งานบ้านงานครัว.xls"');//ชื่อไฟล์
?>

<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white"><strong>ครุภัณฑ์งานบ้านงานครัว สถานะใช้งานปกติ</strong></div>  
        <div class="card-body"> 
