...
header('Content-Disposition: attachment; filename="ทะเบียนครุภัณฑ์อุปกรณ์และส่วนเชื่อมต่อคอมพิวเตอร์.xls"');//ชื่อไฟล์
?>
<body>
    <div>
        <strong>ทะเบียนครุภัณฑ์อุปกรณ์และส่วนเชื่อมต่อคอมพิวเตอร์</strong>
    </div> 
    <div>  
