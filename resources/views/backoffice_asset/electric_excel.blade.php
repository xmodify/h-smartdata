...
header('Content-Disposition: attachment; filename="ครุภัณฑ์ไฟฟ้าและวิทยุ.xls"');//ชื่อไฟล์
?>

<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white"><strong>ครุภัณฑ์ไฟฟ้าและวิทยุ สถานะใช้งานปกติ</strong></div>  
        <div class="card-body"> 
