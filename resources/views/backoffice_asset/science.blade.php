...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">ครุภัณฑ์วิทยาศาสตร์และการแพทย์ สถานะใช้งานปกติ {{$budget_year}}</div>  
        <div class="card-body"> 
                    ...
                    <div class="col-md-12">                         
                        <div class="row">                
                            <div class="col-md-12" align="right" >
                                <a class="btn btn-outline-danger mb-2"  href="{{ url('backoffice_asset/science_pdf') }}" target="_blank" type="submit">
                                    พิมพ์
                                </a>     
                                <a class="btn btn-outline-success mb-2"  href="{{ url('backoffice_asset/science_excel') }}" target="_blank" type="submit">
                                    Excel
                                </a>                    
                            </div>      
                        </div>    
