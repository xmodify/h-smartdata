...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">หัตถการทันตกรรม เปิดการใช้งาน</div>  
        <div class="card-body"> 
                    ...
                    <div class="col-md-12">                          
                        <table id="icd9" class="table table-bordered table-striped">
                            ...
                            <tr class="table-secondary">
                                ...
                                <th class="text-center">ICD10TM</th>
                            ...
                            @foreach($icd9 as $row)          
                            <tr>
                                <td align="left">{{ $row->dttm_group_name }}</td>
                                <td align="right">{{ $row->code }}</td>
                                <td align="left">{{ $row->dttm_name }}</td>
                                <td align="right">{{ number_format($row->dttm_price,2) }}</td>
                                <td align="right">{{ number_format($row->n_price,2) }}</td>
                                ...
                                <td align="left">{{ $row->icd10tm_operation_code }}</td>
                                <td align="left">{{ $row->icd10 }}</td>
                                <td align="center">{{ $row->export_proced }}</td>
                            </tr>
                            @endforeach 
                        </table> 
                    </div> 
...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">หัตถการทันตกรรม ปิดการใช้งาน</div>  
        <div class="card-body"> 
            <div style="overflow-x:auto;">          
                <div class="row">
                    <div class="col-md-12">                          
