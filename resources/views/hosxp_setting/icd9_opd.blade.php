...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">หัตถการผู้ป่วยนอก (OPD,ER) เปิดการใช้งาน</div>  
        <div class="card-body"> 
                ...
                <div class="row">
                    <div class="col-md-12">                          
                        <table id="icd9" class="table table-bordered table-striped">
                            ...
                            @foreach($icd9 as $row)          
                            <tr>
                                <td align="right">{{ $row->er_oper_code }}</td>
                                ...
                                <td align="left">{{ $row->export_proced }}</td>
                            </tr>
                            @endforeach 
                        </table> 
                    </div> 
...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">หัตถการผู้ป่วยนอก (OPD,ER) ปิดการใช้งาน</div>  
        <div class="card-body"> 
            <div style="overflow-x:auto;">          
                <div class="row">
                    <div class="col-md-12">                          
