...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">ทะเบียนยาสมุนไพร เปิดการใช้งาน</div>  
        <div class="card-body"> 
                    ...
                    <div class="col-md-12">                          
                        <table id="drug" class="table table-bordered table-striped">
                            ...
                            <tr class="table-secondary">
                                ...
                                <th class="text-center">รหัสมาตรฐาน TTMT</th> 
                                <th class="text-center">หมวดค่ารักษาพยาบาล</th> 
                                <th class="text-center">32 รายการ</th> 
                                <th class="text-center">9 รายการ</th>                                                 
                            </thead>                          
                            @foreach($drug as $row)          
                            <tr>                          
                                ...
                                <td align="left">{{ $row->herb32 }}</td>
                                <td align="left">{{ $row->herb9 }}</td>
                            </tr>      
                            @endforeach 
                        </table> 
                    </div> 
...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">ทะเบียนยาสมุนไพร ปิดการใช้งาน</div>  
        <div class="card-body"> 
            <div style="overflow-x:auto;">          
                <div class="row">
                    <div class="col-md-12">                          
                        <table id="drug_non_active" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td align="center">{{ $row->code_24 }}</td>
                                <td align="center">{{ $row->code_tmt }}</td>
                                <td align="center">{{ $row->ttmt_code }}</td>                               
                                <td align="left">{{ $row->income_name }}</td>
                                <td align="left">{{ $row->herb32 }}</td>
                                <td align="left">{{ $row->herb9 }}</td>
                            </tr>
