...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">ทะเบียนยานอก รพ. เปิดการใช้งาน</div>  
        <div class="card-body"> 
...
<div class="container-fluid">
    <div class="card">
    <div class="card-header bg-primary text-white">ทะเบียนยานอก รพ. ปิดการใช้งาน</div>  
        <div class="card-body"> 
            <div style="overflow-x:auto;">          
                <div class="row">
                    <div class="col-md-12">                          
