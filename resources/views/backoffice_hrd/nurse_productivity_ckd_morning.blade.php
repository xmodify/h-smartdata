...
<!-- <div class="container"> -->
    <div class="card">        
        <h5 class="alert alert-primary text-center"><strong>ระบบบันทึกผลิตภาพทางการพยาบาล<br>แผนกผู้ป่วยโรคไต CKD</strong></h5> 
        <div class="card-body">
            <div class="row mb-3"> 
            ...
            <form action="{{ route('nurse_productivity_ckd_morning_save') }}" method="POST" enctype="multipart/form-data">
                @csrf
