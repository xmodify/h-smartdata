...
<!-- <div class="container"> -->
    <div class="card">        
        <h5 class="alert alert-primary text-center"><strong>ระบบบันทึกผลิตภาพทางการพยาบาล<br>แผนกผู้ป่วยใน VIP</strong></h5> 
        <div class="card-body">
            <div class="row mb-3"> 
            ...
            <form action="{{ route('nurse_productivity_vip_morning_save') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <label class="form-label">จำนวนผู้ป่วยเวรเช้า <strong>{{ $row->patient_all }}</strong> ราย</label>  
