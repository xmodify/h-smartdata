...
<!-- <div class="container"> -->
    <div class="card">        
        ...
        <div class="card-body">
            ...
            <form action="{{ route('nurse_productivity_er_night_save') }}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="mb-3">
                    ...
                    <label class="form-label">จำนวนผู้ป่วยเวรดึก <strong>{{ $row->visit }}</strong> ราย</label>  
