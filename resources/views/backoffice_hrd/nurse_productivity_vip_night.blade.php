...
<!-- <div class="container"> -->
    <div class="card">        
        ...
        <div class="card-body">
            ...
            <form action="{{ route('nurse_productivity_vip_night_save') }}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="mb-3">
                    ...
                    <label class="form-label">จำนวนผู้ป่วยเวรดึก <strong>{{ $row->patient_all }}</strong> ราย</label>  
