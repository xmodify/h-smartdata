...
<div class="container-fluid">  
    ...
    <div class="row">                          
        ...
        <div class="col-md-4" align="right">
            <a class="btn btn-success my-2 " href="{{ url('service_drug/value_drug_herb_32_excel') }}" target="_blank" type="submit">
            Excel
            </a>                    
        </div>      
    </div>
...
<div class="container-fluid">  
    <div class="card">         
        <div class="card-header bg-primary bg-opacity-75 text-white">ข้อมูลการใช้ยาสมุนไพร 32 รายการ ผู้ป่วยนอก วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</div>      
        <div class="card-body">
