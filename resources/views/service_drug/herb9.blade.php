...
@section('content')
    ...
    <div class="container-fluid">   
        ...
        <div class="alert alert-success text-primary" role="alert"><strong>ข้อมูลการใช้ยาสมุนไพร 9 รายการ วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong></div>
    ...
    <script>
        ...
        $('#t_opd').DataTable({
            ...
            buttons: [
                ...
                title: 'ข้อมูลการใช้ยาสมุนไพร 9 รายการ ผู้ป่วยนอก วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
                }
            ],
            language: {
                search: "ค้นหา:",
    ...
    <script>
        ...
        $('#t_ipd').DataTable({
            ...
            buttons: [
                ...
                text: 'Excel',
                className: 'btn btn-success',
                title: 'ข้อมูลการใช้ยาสมุนไพร 9 รายการ ผู้ป่วยใน วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
                }
            ],
            language: {
                search: "ค้นหา:",
