...
header('Content-Disposition: attachment; filename="มูลค่าการใช้ยา 20 อันดับ.xls"');//ชื่อไฟล์
?>
        
<div><strong>ข้อมูลการใช้ยา วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong></div>      
