...
<div class="container-fluid">  
    ...
    <div class="row">                          
        ...
        <div class="col-md-4" align="right">
            <a class="btn btn-success my-2 " href="{{ url('service_drug/value_drug_top_excel') }}" target="_blank" type="submit">
            Excel
            </a>                    
        </div>      
    </div>
...
<div class="container-fluid">  
    <div class="card">         
        <div class="card-header bg-primary bg-opacity-75 text-white">มูลค่าการใช้ยา 20 อันดับ วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</div>      
        <div class="card-body">
            ...
            <div style="overflow-x:auto;"> 
                <table id="drug" class="table table-bordered table-striped my-3">
                    ...
                    <tr class="table-primary">
                        ...
                        <th class="text-center">ต้นทุนยารวม</th>
                    ...
                    <tr>   
                        ...
                        <td align="right"><strong>{{ number_format($sum_sum_cost,2)}}</strong></td>
            ...
            <div style="overflow-x:auto;"> 
                <table id="drug_ipd" class="table table-bordered table-striped my-3">
                    ...
                    <?php $sum_lgo_price = 0 ; ?>
                    <?php $sum_other_price = 0 ; ?>
                    @foreach($value_drug_top_ipd as $row)          
                    <tr>
                        <td align="right">{{ $count }}</td> 
                        <td align="left">{{ $row->icode }}</td>
                        <td align="left">{{ $row->dname }}</td>
