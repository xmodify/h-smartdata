...
header('Content-Disposition: attachment; filename="มูลค่าการใช้ยาสมุนไพร 32 รายการ.xls"');//ชื่อไฟล์
?>
        
<div><strong>ข้อมูลการใช้ยาสมุนไพร 32 รายการ วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong></div>      
