...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-6">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">ระยะเวลารอคอยเฉลี่ย OPD ปีงบประมาณ {{ $budget_year }} </div>        
        <div class="card-body">
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">ระยะเวลารอคอยเฉลี่ย OPD ปีงบประมาณย้อนหลัง </div>        
        <div class="card-body">
          <table class="table table-bordered table-striped">
            <thead>
              <tr class="table-secondary">                  
