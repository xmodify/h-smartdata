    ...
    <div class="row justify-content-center">  
        <div class="col-md-12"> 
            <div class="card border-primary">
                <div class="card-header bg-primary text-white">ข้อมูล Statement ประกันสุขภาพ UCS [ฟอกไต HD]</div>
                <div class="card-body">
                    <form action="{{ url('finance_stm/stm_ucs_kidney_save') }}" method="POST" enctype="multipart/form-data">
                        @csrf      
                        <div class="row mb-2">            
                            <div class="col"></div>
                                <div class="col-md-5">
                ...
                <div class="card-body">
                    <div style="overflow-x:auto;">   
                        <table id="stm_ucs_kidney" class="table table-bordered table-striped my-3">
                            <thead>
