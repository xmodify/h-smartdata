...
<div class="container-fluid">
    <div class="row justify-content-center">  
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form id="importForm" onsubmit="simulateProcess(event)" action="{{ url('hrims/import_stm/lgo_kidney_save') }}" method="POST" enctype="multipart/form-data">
                    @csrf      
                    <div class="row mb-2">            
                        <div class="col"></div>
                            <div class="col-md-5">
                    ...
                    <table id="stm_lgo_kidney" class="table table-bordered table-striped my-3">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td align="right" class="text-success">{{ number_format($row->compensate_kidney,2) }}</td>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById('btnSaveReceipt')
                .addEventListener('click', function () {
                    ...
                    fetch("{{ url('hrims/import_stm/lgo_kidney_updateReceipt') }}", {
                        method: "POST",
                        headers: {
