...
<div class="container-fluid">
    <div class="row justify-content-center">   
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form id="importForm" onsubmit="simulateProcess(event)" action="{{ url('hrims/import_stm/sss_kidney_save') }}" method="POST" enctype="multipart/form-data">
                    @csrf      
                    <div class="row mb-2">            
                        <div class="col"></div>
                            <div class="col-md-5">
            ...
            <div class="alert alert-success text-primary" role="alert">
                <strong>ข้อมูล Statement ประกันสังคม SSS [ฟอกไต]</strong>
            </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById('btnSaveReceipt')
                .addEventListener('click', function () {
                    ...
                    fetch("{{ url('hrims/import_stm/sss_kidney_updateReceipt') }}", {
                        method: "POST",
                        headers: {
