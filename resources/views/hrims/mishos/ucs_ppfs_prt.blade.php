...
<div class="container-fluid"> 
  ...
  <div class="alert alert-success text-primary" role="alert"><strong>รายชื่อผู้รับบริการทดสอบการตั้งครรภ์ (PRT) วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong></div>
          ...
          <table id="t_search" class="table table-striped table-bordered" width = "100%">
            ...
            <tbody> 
              ...
              <tr>
                ...
                <td align="left">{{ $row->lab_items_name_ref }}</td>
        ...
        buttons: [
            {
              ...
              title: 'รายชื่อผู้รับบริการทดสอบการตั้งครรภ์ (PRT) วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
            }
        ],
        language: {
            search: "ค้นหา:",
