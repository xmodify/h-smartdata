...
<div class="container-fluid"> 
  ...
  <div class="alert alert-success text-primary" role="alert"><strong>รายชื่อผู้มารับบริการ LGO-OP ฟอกไต วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong></div>
        ...
        buttons: [
            {
              ...
              title: 'รายชื่อผู้มารับบริการ LGO-OP ฟอกไต วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}'
            }
        ],
        language: {
            search: "ค้นหา:",
