<?php
$files = "ลูกหนี้รายตัวผังบัญชี-1102050101.307-ลูกหนี้ค่ารักษา ประกันสังคม-กองทุนทดแทน.xls";
...
<div>        
    <strong>
        <p align=center> 
            ...
            รหัสผังบัญชี 1102050101.307-ลูกหนี้ค่ารักษา ประกันสังคม-กองทุนทดแทน<br>
    ...
    <div class="row justify-content-center">            
        <table width="100%" >
            ...
            <tr>
                ...
                <td align="center">{{ $row->receive_no }} {{ $row->repno }}</td>
