        ...
        <div class="col-md-6">
          <table class="table table-hover">
            ...
            <tbody>   
              ...
              <tr>
                <td><a href="{{ url('hrims/debtor/1102050102_110') }}" target="_blank"><li>1102050102.110-ลูกหนี้ค่ารักษา เบิกจ่ายตรงหน่วยงานอื่น OP</li></td>
              </tr>     
              <tr>
        ...
        <div class="col-md-6">
          <table class="table table-hover">
            ...
            <tbody>   
              ...
              <tr>
                <td><a href="{{ url('hrims/debtor/1102050102_111') }}" target="_blank"><li>1102050102.111-ลูกหนี้ค่ารักษา เบิกจ่ายตรงหน่วยงานอื่น IP</li></td>
              </tr>  
              <tr>
