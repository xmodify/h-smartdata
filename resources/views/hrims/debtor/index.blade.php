        ...
        <div class="col-md-6">
          <table class="table table-hover">
            ...
            <tbody>   
              ...
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.209-ลูกหนี้ค่ารักษา ด้านการสร้างเสริมสุขภาพและป้องกันโรค (P&P)</li></a></td>
              </tr>   
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.216-ลูกหนี้ค่ารักษา UC-OP บริการเฉพาะ (CR)</li></a></td>
              </tr>   
              <tr>
                <td class="text-danger"><li>1102050101.222-ลูกหนี้ค่ารักษา OP-Refer</li></td>
              </tr>  
              <tr>
                <td><a href="# target="_blank"><li>1102050101.301-ลูกหนี้ค่ารักษา ประกันสังคม OP-เครือข่าย</li></a></td>
              </tr>   
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.303-ลูกหนี้ค่ารักษา ประกันสังคม OP-นอกเครือข่าย สังกัด สป.สธ.</li></a></td>
              </tr>      
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.307-ลูกหนี้ค่ารักษา ประกันสังคม-กองทุนทดแทน</li></a></td>
              </tr>  
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.309-ลูกหนี้ค่ารักษา ประกันสังคม-ค่าใช้จ่ายสูง/อุบัติเหตุ/ฉุกเฉิน OP</li></a></td>
              </tr>    
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.401-ลูกหนี้ค่ารักษา เบิกจ่ายตรงกรมบัญชีกลาง OP</li></a></td>
              </tr>   
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.501-ลูกหนี้ค่ารักษา คนต่างด้าวและแรงงานต่างด้าว OP</li></a></td>
              </tr>     
              <tr>
              ...
              <tr>
                <td><a href="#" target="_blank"><li>1102050101.703-ลูกหนี้ค่ารักษา บุคคลที่มีปัญหาสถานะและสิทธิ เบิกจากส่วนกลาง OP</li></a></td>
              </tr> 
              <tr>
                <td><a href="#" target="_blank"><li>1102050102.106-ลูกหนี้ค่ารักษา ชําระเงิน OP</li></a></td>
              </tr>   
              <tr>
                <td><a href="#" target="_blank"><li>1102050102.108-ลูกหนี้ค่ารักษา เบิกต้นสังกัด OP</li></a></td>
              </tr>      
              <tr>
