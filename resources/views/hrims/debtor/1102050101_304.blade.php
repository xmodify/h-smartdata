            ...
            <form action="{{ url('hrims/debtor/1102050101_304_delete') }}" method="POST" enctype="multipart/form-data">
                ...
                <table id="debtor" class="table table-bordered table-striped my-3">
                    ...
                    <tr class="table-success">
                        ...
                        <th class="text-center" colspan = "11">1102050101.304-ลูกหนี้ค่ารักษา ประกันสังคม IP นอกเครือข่าย สังกัด สป.สธ. วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</th> 
