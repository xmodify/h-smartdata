<?php
$files = "ลูกหนี้รายตัวผังบัญชี-1102050102.801-ลูกหนี้ค่ารักษา เบิกจ่ายตรง อปท.OP.xls";
...
<div>        
    <strong>
        <p align=center> 
            ...
            รหัสผังบัญชี 1102050102.801-ลูกหนี้ค่ารักษา เบิกจ่ายตรง อปท.OP<br>
    ...
    <div class="row justify-content-center">            
        <table width="100%" >
            ...
            <tr>
                ...
                <td align="right">{{ number_format($row->receive_lgo,2) }}</td>
            ...
            <tr>
                ...
                <td align="right"><strong>{{number_format($sum_lgo,2)}}&nbsp;</strong></td>
