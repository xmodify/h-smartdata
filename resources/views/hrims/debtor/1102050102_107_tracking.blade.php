...
<body>
    ...
    <div class="container">  
        <div class="row"  >            
            <div class="col-sm-12"> 
                <div class="alert alert-success text-primary text-center"><strong>การติดตามลูกหนี้ค่ารักษา ชําระเงิน IP</strong></div>          
            </div>            
        </div>  
        <div class="row">  
            ...
            <div class="col-sm-6">                 
                <p class="text-primary">
                    วันที่รับบริการ: <strong>{{DateThai($row->dchdate)}}</strong> เวลา: <strong>{{$row->dchtime}}</strong>             
                </p> 
                <p class="text-primary">
