...
<div class="container-fluid">
    <h5 class="alert alert-primary"><strong>รายงานผลิตภาพทางการพยาบาลแผนกห้องคลอด (LR)</strong></h5>  
</div> 
...
<div class="container-fluid"> 
    <div class="card">
        <div class="card-header text-white" style="background-color:#23A7A7;">
            <strong>รายงานสรุปผลิตภาพทางการพยาบาล วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong>
        </div> 
        <div class="card-body">
            <table class="table table-bordered table-striped my-3">
                <thead>
                    <tr class="table-primary">
                        ...
                        <th class="text-center">OPD ปกติ</th>
                        <th class="text-center">OPD เร่งด่วน</th>
                        ...
                        <th class="text-center">Oncall</th>
                        <th class="text-center">เสริม</th>
...
<div class="container-fluid"> 
    <div class="card">
        <div class="card-header text-white" style="background-color:#23A7A7;">
            <strong>การบันทึกข้อมูลผลิตภาพทางการพยาบาล วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong>
        </div> 
        <div class="card-body">  
            <div class="row mb-3"> 
            ...
            <table id="productivity_lr" class="table table-bordered table-striped my-3">
                <thead>
                    <tr class="table-primary">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <form action="{{ url('hnplus/product/lr_product_delete/'.$row->id) }}" method="POST" onsubmit="return confirm('ต้องการลบข้อมูล {{ DateThai($row->report_date) }} {{ $row->shift_time }} Product {{ number_format($row->productivity,2) }}?')">
                            @csrf
                            @method('DELETE')
