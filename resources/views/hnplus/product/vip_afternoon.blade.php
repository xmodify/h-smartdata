    ...
    <div class="container py-4">
        <div class="card mx-auto" style="max-width: 700px;">
            <div class="card-header text-white text-center" style="background-color:#23A7A7;">
                <h5 class="mb-0">
                    <strong>ระบบบันทึกผลิตภาพทางการพยาบาล<br>แผนกผู้ป่วยใน VIP<br>เวรบ่าย</strong>
                </h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form id="productForm" action="{{ url('hnplus/product/vip_afternoon_save') }}" method="POST">
                    @csrf
