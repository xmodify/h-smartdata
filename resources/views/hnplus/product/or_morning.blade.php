    ...
    <div class="container py-4">
        <div class="card mx-auto" style="max-width: 700px;">
            ...
            <div class="card-header text-white text-center">
                <h5 class="mb-0">
                    <strong>ระบบบันทึกผลิตภาพทางการพยาบาล<br>แผนกผู้ป่วยผ่าตัด OR<br>เวรเช้า</strong>
                </h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form id="orForm" action="{{ url('hnplus/product/or_morning_save') }}" method="POST">
                    @csrf
...
============================ -->
<script>
    document.getElementById('orForm').addEventListener('submit', function (e) {
        e.preventDefault();
