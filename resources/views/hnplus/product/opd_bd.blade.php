    ...
    <div class="container py-4">
        <div class="card mx-auto" style="max-width: 700px;">
            ...
            <div class="card-header text-white text-center">
                <h5 class="mb-0">
                    <strong>ระบบบันทึกผลิตภาพทางการพยาบาล<br>แผนกผู้ป่วยนอก OPD<br>เวร BD</strong>
                </h5>
            </div>
            ...
            <div class="card-body">
                ...
                <h6 class="text-primary text-center mb-3">
                    วันที่ {{ DateThai(date('Y-m-d')) }} <br> ช่วงเวลา 16.00–19.00 น.
                </h6>

                <form id="opdForm" action="{{ url('hnplus/product/opd_bd_save') }}" method="POST">
                    @csrf
