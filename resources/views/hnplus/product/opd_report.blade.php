...
<div class="container-fluid">
    <h5 class="alert alert-primary"><strong>รายงานผลิตภาพทางการพยาบาลแผนกผู้ป่วยนอก OPD</strong></h5>  
</div> 
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped my-3">
                ...
                <tr>
                    ...
                    <td align="right">{{ $row->opd }}</td>
                    <td align="right">{{ $row->ari }}</td>
...
<div class="container-fluid"> 
    <div class="card">
        ...
        <div class="card-body">  
            ...
            <table id="productivity_opd" class="table table-bordered table-striped my-3">
                <thead>
                    <tr class="table-primary">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <form action="{{ url('hnplus/product/opd_product_delete/'.$row->id) }}" method="POST" onsubmit="return confirm('ต้องการลบข้อมูล {{ DateThai($row->report_date) }} {{ $row->shift_time }} Product {{ number_format($row->productivity,2) }}?')">
                            @csrf
                            @method('DELETE')
