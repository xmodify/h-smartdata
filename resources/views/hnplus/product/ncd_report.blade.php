...
<div class="container-fluid"> 
    <div class="card">
        ...
        <table class="table table-bordered table-striped my-3">
                ...
                <?php $count = 1 ; ?>
                @foreach($sum_productivity_ncd as $row)
                    <tr>
...
<div class="container-fluid"> 
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="nurse_productivity_ncd" class="table table-bordered table-striped my-3">
                <thead>
                    <tr class="table-secondary">
                ...
                <?php $count = 1 ; ?>
                @foreach($nurse_productivity_ncd as $row)
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{url('backoffice_hrd/nurse_productivity_ncd_delete',$row->id)}}" method="GET">
...
<script type="text/javascript" class="init">
    $(document).ready(function () {
        $('#nurse_productivity_ncd').DataTable();
    });
</script>
