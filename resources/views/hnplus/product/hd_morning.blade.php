...
<!-- <div class="container"> -->
    <div class="card">        
        <h5 class="alert alert-primary text-center"><strong>ระบบบันทึกผลิตภาพทางการพยาบาล<br>ศูนย์ฟอกไต HD รพ.</strong></h5> 
        <div class="card-body">
            <div class="row mb-3"> 
            ...
            <h5 class="text-primary">วันที่ {{DateThai(date('Y-m-d'))}} </h5><br>
            <form action="{{ route('nurse_productivity_hd_service_save') }}" method="POST" enctype="multipart/form-data">
                @csrf
