...
<div class="container-fluid">
    <h5 class="alert alert-primary"><strong>รายงานผลิตภาพทางการพยาบาลแผนกห้องผ่าตัด OR</strong></h5>  
</div> 
<div class="container-fluid">  
...
<div class="container-fluid"> 
    <div class="card">
        ...
        <table class="table table-bordered table-striped my-3">
                ...
                <?php $count = 1 ; ?>
                @foreach($sum_productivity_or as $row)
                    <tr>
...
<div class="container-fluid"> 
    <div class="card">
        ...
        <div class="card-body"> 
            ...
            <table id="nurse_productivity_or" class="table table-bordered table-striped my-3">
                <thead>
                    <tr class="table-secondary">
                ...
                <?php $count = 1 ; ?>
                @foreach($nurse_productivity_or as $row)
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{url('backoffice_hrd/nurse_productivity_or_delete',$row->id)}}" method="GET">
...
<script type="text/javascript" class="init">
    $(document).ready(function () {
        $('#nurse_productivity_or').DataTable();
    });
</script>
