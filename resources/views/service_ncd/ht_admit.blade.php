...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยโรคความดัน ที่ Admit ปีงบประมาณ {{$budget_year}} </div>
        <canvas id="admit_month" style="width: 100%; height: 350px"></canvas>
      </div>
    </div>
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยโรคความดัน ที่ Admit 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">
    <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยโรคความดัน ที่ Admit ปีงบประมาณ {{$budget_year}}</div>
        <div class="card-body">
          <table id="admit_ht" class="table table-bordered table-striped my-3">
            <thead>
            <tr class="table-secondary">
                ...
                <th class="text-center">ICD10 HT</th>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      new Chart(document.querySelector('#admit_month'), {
        ...
        data: {
          ...
          datasets: [{
            label: 'Admit',
            data: <?php echo json_encode($admit_ht_m); ?>,
            backgroundColor: [
              'rgba(255, 159, 64, 0.2)'
            ],
            borderColor: [
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        new ApexCharts(document.querySelector("#admit_year"), {
            ...
            series: [{
                name: 'Admit',
                data: <?php echo json_encode($admit_ht_y); ?>,
                    }],
