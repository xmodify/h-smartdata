...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">ทะเบียนผู้ป่วยคลินิกเบาหวาน</div>
...
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-7">
        <div class="card">
          <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยคลินิกเบาหวาน รายใหม่ ปีงบประมาณ {{$budget_year}} </div>
          <canvas id="month" style="width: 100%; height: 350px"></canvas>
        </div>
      </div>
      <div class="col-md-5">
        <div class="card">
          <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยคลินิกเบาหวาน-ความดัน รายใหม่ 5 ปีงบประมาณย้อนหลัง </div>
