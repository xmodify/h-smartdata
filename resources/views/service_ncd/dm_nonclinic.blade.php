...
<div class="container-fluid">
    <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยโรคเบาหวานที่ยังไม่ขึ้นทะเบียนคลินิก วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</div>
        <div class="card-body">
            <table id="dm_nonclinic" class="table table-bordered table-striped my-3">
                <thead>
