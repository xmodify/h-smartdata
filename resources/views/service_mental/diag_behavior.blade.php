...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยความผิดปกติเกียวกับพฤติกรรม(ผู้ป่วยนอก) ปีงบประมาณ {{$budget_year}} </div>
        <canvas id="diag_month" style="width: 100%; height: 350px"></canvas>             
      </div>      
    </div>   
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยความผิดปกติเกียวกับพฤติกรรม(ผู้ป่วยนอก) 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">   
  <div class="card">
    <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยความผิดปกติเกียวกับพฤติกรรม(ผู้ป่วยนอก) ปีงบประมาณ {{$budget_year}} </div>
    <div class="card-body">
...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยความผิดปกติเกียวกับพฤติกรรม(ผู้ป่วยใน) ปีงบประมาณ {{$budget_year}} </div>
        <canvas id="diag_month_ipd" style="width: 100%; height: 350px"></canvas>             
      </div>      
    </div>   
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยความผิดปกติเกียวกับพฤติกรรม(ผู้ป่วยใน) 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">   
  <div class="card">
    <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยความผิดปกติเกียวกับพฤติกรรม(ผู้ป่วยใน) ปีงบประมาณ {{$budget_year}} </div>
    <div class="card-body">
