...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยนอกโรค Palliative Care ปีงบประมาณ {{$budget_year}} </div>
        <canvas id="diag_month" style="width: 100%; height: 350px"></canvas>             
      </div>      
    </div>   
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยนอกโรค Palliative Care 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">   
  <div class="card">
    <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยนอกโรค Palliative Care ปีงบประมาณ {{$budget_year}} </div>
...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยในโรค Palliative Care ปีงบประมาณ {{$budget_year}} </div>
        <canvas id="diag_month_ipd" style="width: 100%; height: 350px"></canvas>             
      </div>      
    </div>   
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยในโรค Palliative Care 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">   
  <div class="card">
    <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยในโรค Palliative Care ปีงบประมาณ {{$budget_year}} </div>
    <div class="card-body" style="overflow-x:auto;">
...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วย Refer ด้วยโรค Palliative Care ปีงบประมาณ {{$budget_year}} </div>
        <canvas id="refer_month" style="width: 100%; height: 350px"></canvas>             
      </div>      
    </div>  
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วย Refer ด้วยโรค Palliative Care 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">   
  <div class="card">
    <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยส่งต่อ Refer ด้วยโรค Palliative Care ปีงบประมาณ {{$budget_year}} </div>
    <div class="card-body" style="overflow-x:auto;">
