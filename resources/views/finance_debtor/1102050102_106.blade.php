...
<div class="container-fluid"> 
    <div style="overflow-x:auto;">
        <form action="{{ url('finance_debtor/1102050102_106_delete') }}" method="POST" enctype="multipart/form-data">
            @csrf   
            @method('DELETE')
            <table id="debtor" class="table table-bordered table-striped my-3">
                ...
                <tr>
                    ...
                    <td align="right" width="9%">
                        ...
                        @endif 
                        <a class="btn btn-outline-info btn-sm" href="{{ url('finance_debtor/1102050102_106/tracking', $row->vn) }}" target="_blank">ติดตาม {{ $row->visit }}</a> 
                    </td>   
        ...
        <table class="table table-bordered ">
            ...
            <tr>
                ...
                <td align="center">
                    <a class="btn btn-outline-success btn-sm" href="{{ url('finance_debtor/1102050102_106_indiv_excel')}}" target="_blank">ส่งออกรายตัว</a>                
...
<hr>
    ...
    <div class="tab-content pt-2" id="myTabContent">
        <div class="tab-pane fade show active" id="pay" role="tabpanel" aria-labelledby="pay-tab">
            <div style="overflow-x:auto;">
                <form action="{{ url('finance_debtor/1102050102_106_confirm') }}" method="POST" enctype="multipart/form-data">
                    @csrf                
        ...
        <div class="tab-pane fade" id="iclaim" role="tabpanel" aria-labelledby="iclaim-tab">
            <div style="overflow-x:auto;">
                <form action="{{ url('finance_debtor/1102050102_106_confirm_iclaim') }}" method="POST" enctype="multipart/form-data"> 
                    @csrf                
...
<div id="receive-{{ $row->vn }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="receive-{{ $row->vn }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action={{ url('finance_debtor/1102050102_106/update', $row->vn) }} method="POST">
            @csrf
            @method('PUT')
