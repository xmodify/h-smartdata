...
<div class="container-fluid">
    <div style="overflow-x:auto;">
        <form action="{{ url('finance_debtor/1102050102_802_delete') }}" method="POST" enctype="multipart/form-data">
            @csrf   
            @method('DELETE')
            <table id="debtor" class="table table-bordered table-striped my-3">
                ...
                <tr class="table-success">
                    ...
                    <th class="text-center" colspan = "12">1102050102.802-ลูกหนี้ค่ารักษา เบิกจ่ายตรง อปท.IP วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</th> 
                ...
                <tr class="table-success">
                    ...
                    <th class="text-center text-primary">Eclaim</th>  
                ...
                <tr>
                    ...
                    <td align="right">{{ number_format($row->receive_eclaim,2) }}</td>
                ...
                <?php $sum_receive_eclaim += $row->receive_eclaim ; ?> 
        ...
        <table class="table table-bordered ">
            ...
            <tr class="table-primary" >
                ...
                <th class="text-center">ชดเชยฟอกไต</th>  
                <th class="text-center">ชดเชย Eclaim</th>
            ...
            <tr>
                <td class="text-primary" align="right">1102050102.802</td>
                <td class="text-primary" align="left">802-ลูกหนี้ค่ารักษา เบิกจ่ายตรง อปท.IP</td>
                ...
                <td align="right" @if($sum_receive_eclaim > 0) style="color:green" 
                    @elseif($sum_receive_eclaim < 0) style="color:red" @endif>
                    {{ number_format($sum_receive_eclaim,2)}}
                </td>
                ...
                <td align="right" @if(($sum_receive_total-$sum_debtor) > 0) style="color:green" 
                    @elseif(($sum_receive_total-$sum_debtor) < 0) style="color:red" @endif>
                    <strong>{{ number_format($sum_receive_total-$sum_debtor,2)}}</strong>
                </td>
                <td align="center">
                    <a class="btn btn-outline-success btn-sm" href="{{ url('finance_debtor/1102050102_802_indiv_excel')}}" target="_blank">ส่งออกรายตัว</a>                
...
<hr>
    <div style="overflow-x:auto;">
        <form action="{{ url('finance_debtor/1102050102_802_confirm') }}" method="POST" enctype="multipart/form-data">
            @csrf                
            <table id="debtor_search" class="table table-bordered table-striped my-3">
                ...
                <tr class="table-secondary">
                    ...
                    <th class="text-center" colspan = "15">ผู้มารับบริการเบิกจ่ายตรง อปท.IP วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }} รอยืนยันลูกหนี้</th>                         
                </tr>
                <tr class="table-secondary">
