    ...
    <div class="row justify-content-center">            
        <table width="100%" >
            ...
            <tr>
                ...
                <th class="text-center text-primary">บริการเฉพาะ</th>
                <th class="text-center text-primary">ฟอกไต</th>
                <th class="text-center text-primary">ชดเชย</th> 
                <th class="text-center text-primary">ผลต่าง</th> 
                <th class="text-center text-primary">REP</th> 
                <th class="text-center text-primary">REP ฟอกไต</th>  
            </tr>     
            </thead> 
            <?php $count = 1 ; ?>
            <?php $sum_income = 0 ; ?>
            ...
            <tr>
                ...
                <td align="center">{{ $row->repno_kidney }}</td>
            </tr>                
            <?php $count++; ?>
            ...
            <tr>
                ...
                <td class="text-primary" align="right"><strong>{{ number_format($sum_income,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_rcpt_money,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_kidney,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_cr,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_debtor,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_receive_cr,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_receive_kidney,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_receive,2)}}</strong></td>
                <td class="text-primary" align="right"><strong>{{ number_format($sum_receive-$sum_debtor,2)}}</strong></td>
            </tr>          
        </table> 
    </div>
</div>    
