<?php
$files = "ลูกหนี้รายตัวผังบัญชี-1102050101.402-ลูกหนี้ค่ารักษา-เบิกจ่ายตรง กรมบัญชีกลาง IP.xls";
...
<div>        
    <strong>
        <p align=center>
            ...
            รหัสผังบัญชี 1102050101.402-ลูกหนี้ค่ารักษา-เบิกจ่ายตรง กรมบัญชีกลาง IP<br>
        ...
        <table width="100%" >
            ...
            <tr>
                ...
                <th class="text-center">HN</th>
                    ...
                    <th class="text-center text-primary">ชดเชยฟอกไต</th> 
                    <th class="text-center text-primary">ชดเชย Eclaim</th>
                    <th class="text-center text-primary">ชดเชยทั้งหมด</th> 
            ...
            <tr>
                ...
                <td align="center">{{ $row->hn }}</td>
                    ...
                    <td align="right">{{ number_format($row->receive_total-$row->debtor,2) }}</td>  
            ...
            <tr>
                ...
                <td align="right"><strong>{{number_format($sum_receive_eclaim,2)}}&nbsp;</strong></td> 
                <td align="right"><strong>{{number_format($sum_receive_total,2)}}&nbsp;</strong></td> 
                <td align="right"><strong>{{number_format($sum_receive_total-$sum_debtor,2)}}&nbsp;</strong></td>
            </tr>          
        </table> 
    </div>
</div>    
