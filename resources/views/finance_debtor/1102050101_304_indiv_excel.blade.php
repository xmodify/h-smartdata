<?php
$files = "ลูกหนี้รายตัวผังบัญชี-1102050101.304-ลูกหนี้ค่ารักษา ประกันสังคม IP นอกเครือข่าย สังกัด สป.สธ..xls";
...
<div>        
    <strong>
        <p align=center>
            ...
            รหัสผังบัญชี 1102050101.304-ลูกหนี้ค่ารักษา ประกันสังคม IP นอกเครือข่าย สังกัด สป.สธ.<br>
    ...
    <div class="row justify-content-center">            
        <table width="100%" >
            ...
            <tr>
                ...
                <td align="right"><strong>{{number_format($sum_income_pttype,2)}}&nbsp;</strong></td>  
