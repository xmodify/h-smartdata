        ...
        <table id="debtor" class="table table-bordered table-striped my-3">
            <thead>  
                <tr class="table-success">
                    ...
                    <th class="text-center"><a class="btn btn-outline-danger" href="{{ url('finance_debtor/summary_pdf')}}" target="_blank">พิมพ์สรุป</a></th>
                </tr>
            </thead>
                <tr>
                ...
                <tr>            
                    ...
                    <td align="center">
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_103_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>  
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_109_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>   
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_201_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_203_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_209_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_301_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">              
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_303_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">                
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_307_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">              
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_309_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">              
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_501_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">             
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050102_106_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">             
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050102_108_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050102_602_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">              
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_302_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">              
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_304_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_308_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">              
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_310_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_402_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">                
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_502_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050101_704_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050102_109_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">               
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050102_802_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
                ...
                <tr>
                    ...
                    <td align="center">              
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('finance_debtor/1102050102_804_daily_pdf')}}" target="_blank">พิมพ์รายวัน</a> 
                    </td>
