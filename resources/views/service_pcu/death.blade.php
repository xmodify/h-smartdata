...
<div class="container-fluid">  
    <div class="row justify-content-center">  
        <div class="col-md-12">  
            <div class="card">          
                <div class="card-header bg-primary bg-opacity-75 text-white">สาเหตุการเสียชีวิต วินิจฉัยตามสาเหตุ 21 กลุ่มโรค ต.รัตนวารี ปีงบประมาณ {{ $budget_year }} </div>                            
...
<div class="container-fluid">  
    <div class="row justify-content-center">  
        <div class="col-md-12">  
            <div class="card">          
                <div class="card-header bg-primary bg-opacity-75 text-white">สาเหตุการเสียชีวิต วินิจฉัยตามรหัส ICD10 ต.รัตนวารี ปีงบประมาณ {{ $budget_year }} </div>                            
                    <table class="table table-bordered table-striped">
                        <thead>
                        <tr class="table-secondary">
                            <th class="text-center">อันดับ</th>
