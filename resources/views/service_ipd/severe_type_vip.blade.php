...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยใน VIP แยกระดับความรุนแรง (แรกรับ) ปีงบประมาณ {{ $budget_year }} </div>
        <div id="severe_type_month" style="width: 100%; height: 350px"></div>             
      </div>      
    </div> 
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยใน VIP แยกระดับความรุนแรง (แรกรับ) 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">   
  <div class="card">
    <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยใน VIP ที่ไม่ระบุความรุนแรง (แรกรับ) ปีงบประมาณ {{$budget_year}} </div>
    <div class="card-body">
...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-7">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยใน VIP แยกระดับความรุนแรง (จำหน่าย) ปีงบประมาณ {{ $budget_year }} </div>
        <div id="dch_severe_type_month" style="width: 100%; height: 350px"></div>             
      </div>      
    </div> 
    <div class="col-md-5">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">จำนวนผู้ป่วยใน VIP แยกระดับความรุนแรง (จำหน่าย) 5 ปีงบประมาณย้อนหลัง </div>
...
<div class="container-fluid">   
  <div class="card">
    <div class="card-header bg-primary bg-opacity-75 text-white">รายชื่อผู้ป่วยใน VIP ที่ไม่ระบุความรุนแรง (จำหน่าย) ปีงบประมาณ {{$budget_year}} </div>
    <div class="card-body">
