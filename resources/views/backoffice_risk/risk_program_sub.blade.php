...
<div class="container-fluid">
  <div class="row justify-content-center">  
    <div class="col-md-12">
      <div class="card">
        <div class="card-header bg-primary bg-opacity-75 text-white">{{$RISK_REPPROGRAM_NAME}} ปีงบประมาณ {{$budget_year}}  </div>
          <table class="table table-bordered table-striped">
            <thead>
            <tr class="table-secondary">
                <th class="text-center">โปรแกรมย่อย 1</th>
            ...
            <tr>
                <td align="left"><a href="{{ url('backoffice_risk/program_subsub/'.$row->id)}}" target="_blank"> {{ $row->RISK_REPPROGRAMSUB_NAME }} </a></td> 
                <td align="center"><a href="{{ url('backoffice_risk/program_sub_detail/'.$row->id)}}" target="_blank"> {{ $row->total }} </a></td>      
