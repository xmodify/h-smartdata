...
<div class="container-fluid"> 
    ...
    <div class="alert alert-primary text-primary" role="alert"><strong>ยาสมุนไพร 32 รายการ วันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}</strong></div>
    <div class="card-body"> 
        <!-- Pills Tabs -->
                ...
                <div style="overflow-x:auto;">
                    ...
                    <div class="text-center text-primary">
                        <h4>
                            ...
                            ชดเชยทั้งหมด <strong>{{number_format($sum_receive_hc_hc,2)}} </strong>บาท |
                            ส่วนต่าง <strong>{{number_format($sum_receive_hc_hc-$sum_sum_price,2)}} </strong>บาท
                        </h4>
                    </div>
                </div>
            </div>   
