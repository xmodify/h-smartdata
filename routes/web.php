...
Route::match(['get','post'],'finance_stm/stm_ofc_detail',[Finance_StmController::class,'stm_ofc_detail']);
Route::match(['get','post'],'finance_stm/stm_ofc_kidney',[Finance_StmController::class,'stm_ofc_kidney'])->name('stm_ofc_kidney');
Route::post('finance_stm/stm_ofc_kidney_save',[Finance_StmController::class,'stm_ofc_kidney_save']);
Route::match(['get','post'],'finance_stm/stm_ofc_kidneydetail',[Finance_StmController::class,'stm_ofc_kidneydetail']);
Route::match(['get','post'],'finance_stm/stm_lgo',[Finance_StmController::class,'stm_lgo'])->name('stm_lgo');
Route::post('finance_stm/stm_lgo_save',[Finance_StmController::class,'stm_lgo_save']);
Route::match(['get','post'],'finance_stm/stm_lgo_detail',[Finance_StmController::class,'stm_lgo_detail']);
Route::match(['get','post'],'finance_stm/stm_lgo_kidney',[Finance_StmController::class,'stm_lgo_kidney'])->name('stm_lgo_kidney');
Route::post('finance_stm/stm_lgo_kidney_save',[Finance_StmController::class,'stm_lgo_kidney_save']);
Route::match(['get','post'],'finance_stm/stm_lgo_kidneydetail',[Finance_StmController::class,'stm_lgo_kidneydetail']);
Route::match(['get','post'],'finance_stm/stm_sss_kidney',[Finance_StmController::class,'stm_sss_kidney'])->name('stm_sss_kidney');
Route::post('finance_stm/stm_sss_kidney_save',[Finance_StmController::class,'stm_sss_kidney_save']);
Route::match(['get','post'],'finance_stm/stm_sss_kidneydetail',[Finance_StmController::class,'stm_sss_kidneydetail']);
Route::match(['get','post'],'finance_stm/stm_ucs',[Finance_StmController::class,'stm_ucs'])->name('stm_ucs');
Route::post('finance_stm/stm_ucs_save',[Finance_StmController::class,'stm_ucs_save']);
Route::match(['get','post'],'finance_stm/stm_ucs_detail',[Finance_StmController::class,'stm_ucs_detail']);
Route::match(['get','post'],'finance_stm/stm_ucs_kidney',[Finance_StmController::class,'stm_ucs_kidney'])->name('stm_ucs_kidney');
