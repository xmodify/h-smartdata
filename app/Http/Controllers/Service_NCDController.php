...
//Create dmht_waiting_period------------------------------------------------------------------------------------------------------------------------
public function dmht_waiting_period(Request $request)
{
        set_time_limit(0);
      ...
      $waiting_period_month = DB::connection('hosxp')->select('
            ...
            AND o.main_dep = "011" AND o.vn NOT IN (SELECT vn FROM er_regist)
      ...
      return view('service_ncd.dmht_waiting_period',compact('budget_year_select','budget_year','waiting_period_month','waiting_period_year'));          
}
//Create ht_clinic--------------------------------------------------------------------------------------------------------------------------------------
