...
public function ct(Request $request)
{
  ...
  $ct_list = DB::connection('hosxp')->select('
    ...
    pt.cid,o.hn,o.an,p.hipdata_code,p.`name` AS pttype,IFNULL(vp.hospmain,ip.hospmain) AS hospmain,o.rxdate,o.rxtime,
		TIME(last_modified) AS updatetime,GROUP_CONCAT(DISTINCT s.`name`) AS item_name,SUM(o.qty) AS qty,SUM(o.qty)*nd.price AS price_bill,
    ...
    ORDER BY o.pttype,o.hn,o.rxdate,o.rxtime',[$start_date,$end_date]);  
  ...
  return view('service_xray.ct',compact('start_date','end_date','ct_list'));            
}
